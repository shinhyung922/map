...
<%
			...
			try{
			   ...
			   String sql = "SELECT COUNT(*) FROM board b JOIN likes l ON b.BOARD_ID = l.board_id WHERE l.mem_id = ? AND b.mem_id != ?";
			...
			try{
				...
				Class.forName("com.mysql.cj.jdbc.Driver");
				conn = DriverManager.getConnection(jdbcUrl, dbId, dbPw);
				String sql= "SELECT b.BOARD_ID, b.TITLE, b.mem_id, b.CONTENT, b.VIEW, b.LIKES, b.COMMENT, b.WRITE_DAY, b.img, b.CATEGORY_ID " +
			           		"FROM board b JOIN likes l ON b.BOARD_ID = l.board_id " +
			           	    "WHERE l.mem_id = ? AND b.mem_id != ?";
				pstmt = conn.prepareStatement(sql);
